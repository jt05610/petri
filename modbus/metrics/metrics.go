...
var (
	...
	SerialRequests metrics.Counter = prometheus.NewCounterFrom(
		prom.CounterOpts{
			Namespace: *Namespace,
			Subsystem: *Subsystem,
			Name:      "serial_request_count",
			Help:      "Total serial requests",
		},
		[]string{},
	)
	NoResponseErrors metrics.Counter = prometheus.NewCounterFrom(
		prom.CounterOpts{
			Namespace: *Namespace,
			Subsystem: *Subsystem,
			Name:      "serial_no_response_count",
			Help:      "Total no response errors",
		},
		[]string{},
	)
